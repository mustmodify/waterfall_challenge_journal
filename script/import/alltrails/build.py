...
said, and deleting it invites the next importer to make the same match again.
    ...
    python3 script/import/alltrails/fetch.py      # responses to data/alltrails/raw/
    python3 script/import/alltrails/match.py      # raw -> data/alltrails/verdicts.jsonl
    python3 script/import/alltrails/build.py > db/migrations/059_alltrails_claims.sql
"""
...
def main():
    ...
    out = []
    out.append("-- AllTrails claims, generated by script/import/alltrails/build.py")
